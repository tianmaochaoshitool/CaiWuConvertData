...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        List<Item> ItemList;
        int ItemListStringIndex;
        List<object> ItemListString;
        KeyboardHook k_hook;
        public Form1()
        {
            InitializeComponent();
        ...
        private void hook_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            //判断按下的键（Alt + A） 
            if (e.KeyValue == (int)Keys.V && (int)System.Windows.Forms.Control.ModifierKeys == (int)Keys.Control)
            {
        ...
        private void start_Click(object sender, EventArgs e)
        {
            ...
            //ItemList.Add(new Item { name = "B", count = 2, TotalPrice = 12210.8 });
            //ItemList.Add(new Item { name = "C", count = 3, TotalPrice = 5780.05 });
            //


            ItemListString = new List<object>();
